...
class PostgreSQLCleanupService:
    ...
    def __init__(
        ...
        logger.debug(
            "PostgreSQLCleanupService initialized: "
    ...
    def _check_circuit_breaker(self) -> bool:
        ...
        if hasattr(self._circuit_breaker, 'is_open') and self._circuit_breaker.is_open:
            logger.debug("[PostgreSQL] PostgreSQL cleanup skipped - circuit breaker is OPEN")
            return False
            ...
            if existing_views and not force:
                ...
                if other_views:
                    logger.info(
                        ...
                        "from other sessions - not dropping"
                    )
                    return False
...
def create_cleanup_service(
    ...
    if use_circuit_breaker:
        try:
            ...
            logger.debug("[PostgreSQL] Circuit breaker not available")
