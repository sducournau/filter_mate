...
class FilteringController(BaseController, LayerSelectionMixin):
    ...
    # v5.4 raster filter removed - v9.0 unified filtering handles raster dispatch
    # directly in dockwidget via _execute_raster_transparency_filter / _execute_vector_by_raster_filter
