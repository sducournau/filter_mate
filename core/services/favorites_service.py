...
class FavoritesService(QObject):
    ...
    # Phase 5: Consolidated from FavoritesMigrationService
    ...
    # ─────────────────────────────────────────────────────────────────
    # Migration & Maintenance (Phase 5: consolidated from FavoritesMigrationService)
    # ─────────────────────────────────────────────────────────────────
    ...
    def cleanup_orphan_projects(self, keep_with_favorites: bool = True) -> Tuple[int, List[str]]:
        ...
        try:
            ...
            cursor.execute(f"DELETE FROM fm_projects WHERE project_id IN ({placeholders})", orphan_ids)
