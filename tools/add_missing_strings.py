...
MISSING_STRINGS = {
    ...
    "Number of segments for buffer precision": {
        "en": "Number of segments for buffer precision",
        "fr": "Nombre de segments pour la précision du tampon",
        "de": "Anzahl der Segmente für Puffergenauigkeit",
        "es": "Número de segmentos para precisión del búfer",
        "it": "Numero di segmenti per la precisione del buffer",
        "nl": "Aantal segmenten voor bufferprecisie",
        "pt": "Número de segmentos para precisão do buffer",
        "pl": "Liczba segmentów dla precyzji bufora",
        "zh": "缓冲区精度的段数",
        "ru": "Количество сегментов для точности буфера",
        "id": "Jumlah segmen untuk presisi buffer",
        "vi": "Số đoạn cho độ chính xác đệm",
        "tr": "Tampon hassasiyeti için segment sayısı",
        "hi": "बफर सटीकता के लिए सेगमेंट की संख्या",
        "fi": "Segmenttien määrä puskurin tarkkuudelle",
        "da": "Antal segmenter for bufferpræcision",
        "sv": "Antal segment för buffertprecision",
        "nb": "Antall segmenter for bufferpresisjon",
        "sl": "Število segmentov za natančnost medpomnilnika",
        "tl": "Bilang ng mga segment para sa buffer precision",
        "am": "ለቋት ትክክለኛነት የክፍሎች ቁጥር",
        "uz": "Bufer aniqligi uchun segmentlar soni",
    },
}
